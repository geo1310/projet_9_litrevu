...
from django.contrib.auth import login  # Importation de la fonction de connexion utilisateur
from django.shortcuts import redirect, render  # Importation des fonctions de redirection et de rendu
